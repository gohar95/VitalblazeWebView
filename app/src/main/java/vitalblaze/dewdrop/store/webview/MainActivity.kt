package vitalblaze.dewdrop.store.webview
...
//    private lateinit var adView: AdView;
    ...
    //    var layoutFooter =  findViewById(R.id.layout_footer);


    // set your custom url here
    internal var URL = "https://dewdropskin.com/login "
...
//          showAdMob()
        ...
        btnTryAgain.setOnClickListener(View.OnClickListener {
            ...
            {
                Toast.makeText(this@MainActivity, "Please connect your internet",Toast.LENGTH_LONG).show()
            }
...
//        super.onResume()
    ...
    private fun showAlert() {
        ...
        builder.setMessage("We will be waiting...")
